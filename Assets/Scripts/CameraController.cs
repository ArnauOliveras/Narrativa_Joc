...
public class CameraController : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        if (restartCamTimer >= timeBeforeRestartCamera)
        {
            restartCamTimer = 0;
    ...
    {
        //restartingCamPos = true;

        //Vector3 targetPosition = targetObject.transform.TransformPoint(camStartPos);
        //Vector3 interpolatedPosition = Vector3.Lerp(transform.position, targetPosition, Time.deltaTime * 1);
